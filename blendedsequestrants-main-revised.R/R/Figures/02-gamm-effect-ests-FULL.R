  ...
  mutate(
    term = factor(term,
                  levels = c(
                    ...
                    "ph:mnfe", "si:ph:mnfe", "tmp:ph:mnfe", "si:tmp:ph", "si:tmp:ph:mnfe"
                  ),
                  labels = c(
                    "Intercept", "20 ppm Si", "3 ppm TMP", "pH 9.5", "1 ppm Mn+Fe",
                    "Si x TMP", "Si x pH 9.5", "Si x Mn+Fe", "TMP x pH 9.5", "TMP x Mn+Fe",
                    "pH 9.5 x Mn+Fe", "Si x pH 9.5 x Mn+Fe", "TMP x pH 9.5 x Mn+Fe",
                    "Si x TMP x pH 9.5", "Si x TMP x pH 9.5 x Mn+Fe"
                  )),
